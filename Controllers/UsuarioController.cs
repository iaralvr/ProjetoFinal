...
namespace LoginProjeto.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeUsuario,UsuarioEmail,UsuarioSenha")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeUsuario,UsuarioEmail,UsuarioSenha")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
