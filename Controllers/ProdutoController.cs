...
namespace LoginProjeto.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoNome,ProdutoQuantidade,TipoProdutoId,FornecedorId")] Produto produto)
        {
            ...
            ViewData["FornecedorId"] = new SelectList(_context.Fornecedor, "Id", "TipoProduto", produto.FornecedorId);
            ViewData["TipoProdutoId"] = new SelectList(_context.TipoProduto, "Id", "TipoProduto", produto.TipoProdutoId);
            return View(produto);
        }
